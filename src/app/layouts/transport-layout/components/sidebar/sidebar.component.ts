...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/co-transport/admin/offres', title: 'Offres',  icon:'ni-bullet-list-67 text-red', class: '' },
    { path: '/co-transport/admin/vehicule', title: 'vehicule',  icon:'ni-bullet-list-67 text-red', class: '' },
